...
export namespace TokenMintedEvent {
  export type InputTuple = [tokenId: BigNumberish, recipient: AddressLike];
  export type OutputTuple = [tokenId: bigint, recipient: string];
  export interface OutputObject {
    tokenId: bigint;
    recipient: string;
  }
...
export interface LaunchNFT extends BaseContract {
  ...
  filters: {
    ...
    "BackendSignerUpdated(address)": TypedContractEvent<
      BackendSignerUpdatedEvent.InputTuple,
      BackendSignerUpdatedEvent.OutputTuple,
      BackendSignerUpdatedEvent.OutputObject
    >;
    ...
    "PhaseUpdated(uint8,uint256,uint256,uint256,uint256,uint256,bytes32)": TypedContractEvent<
      PhaseUpdatedEvent.InputTuple,
      PhaseUpdatedEvent.OutputTuple,
      PhaseUpdatedEvent.OutputObject
    >;
    ...
    "TokenMinted(uint256,address)": TypedContractEvent<
      TokenMintedEvent.InputTuple,
      TokenMintedEvent.OutputTuple,
      TokenMintedEvent.OutputObject
    >;
