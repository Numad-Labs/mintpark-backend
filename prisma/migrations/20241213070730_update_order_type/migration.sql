/*
  ...
  - The values [MINT_TRAIT] on the enum `ORDER_TYPE` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ORDER_TYPE_new" AS ENUM ('MINT_COLLECTIBLE', 'MINT_RECURSIVE_COLLECTIBLE', 'LAUNCH_BUY');
