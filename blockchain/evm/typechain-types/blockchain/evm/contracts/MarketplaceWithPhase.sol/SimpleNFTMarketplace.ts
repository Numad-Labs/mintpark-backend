...
export declare namespace SimpleNFTMarketplace {
...
export interface SimpleNFTMarketplaceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "cancelListing"
      | "createListing"
...
export interface SimpleNFTMarketplace extends BaseContract {
  connect(runner?: ContractRunner | null): SimpleNFTMarketplace;
  waitForDeployment(): Promise<this>;

  interface: SimpleNFTMarketplaceInterface;
  ...
  getListing: TypedContractMethod<
    [listingId: BigNumberish],
    [SimpleNFTMarketplace.ListingStructOutput],
    "view"
  >;
