...
export declare namespace MultiCollectionPhasedMarketplace {
...
export interface MultiCollectionPhasedMarketplaceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "cancelListing"
      | "collectionPhases"
...
export interface MultiCollectionPhasedMarketplace extends BaseContract {
  connect(runner?: ContractRunner | null): MultiCollectionPhasedMarketplace;
  waitForDeployment(): Promise<this>;

  interface: MultiCollectionPhasedMarketplaceInterface;
  ...
  getCollectionConfig: TypedContractMethod<
    [nftContract: AddressLike],
    [MultiCollectionPhasedMarketplace.PhaseConfigStructOutput],
    "view"
  >;
  ...
  getListing: TypedContractMethod<
    [listingId: BigNumberish],
    [MultiCollectionPhasedMarketplace.ListingStructOutput],
    "view"
  >;
